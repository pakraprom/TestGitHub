...
$cmsBlocks = array(
    array(
        ...
        'content'       => "
<ul>
    <li><a href=\"{{store direct_url=\"about-magento-demo-store\"}}\">O Nama</a></li>
    <li class=\"last\"><a href=\"{{store direct_url=\"customer-service\"}}\">Korisnički Servis</a></li>
</ul>",
        'is_active'     => 1,
        'stores'        => 0
    )
...
<div class="links">
    ...
    <ul>
        <li><a href="{{store url=""}}about-magento-demo-store/">O Nama</a></li>
        <li><a href="{{store url=""}}contacts/">Contact Us</a></li>
        <li><a href="{{store url=""}}customer-service/">Korisnički Servis</a></li>
